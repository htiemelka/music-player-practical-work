...
На изображении выше видно что поток данных от нашего приложения для примера - SoundID (примером для приложения аудио фильтра), делится на три потока, с разными местами хранения данных пользователя.
